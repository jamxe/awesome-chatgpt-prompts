...
export function SidebarFooter() {
  ...
  return (
    <div className="mt-6 pt-4 border-t text-xs text-muted-foreground space-y-3">
      <nav className="flex flex-col gap-2">
        {!branding.useCloneBranding && (
          <>
            <Link href="https://deepwiki.com/f/awesome-chatgpt-prompts" target="_blank" rel="noopener noreferrer" className="hover:text-foreground flex items-center gap-1.5">
        ...
        <Link href="https://github.com/f/awesome-chatgpt-prompts" target="_blank" rel="noopener noreferrer" className="hover:text-foreground flex items-center gap-1.5">
      ...
      <p className="flex items-center gap-1">
        <Image src="/logo.svg" alt="" width={12} height={12} className="dark:invert" />
